import{L as y}from"./lenis-BRqnZd4Q.js";class b{constructor(e){this.container=e||document.body,this.lenis=null,this.rafId=null,this.currentScroll=0,this.scrollVelocity=0,this.targetVelocity=0,this.currentBend=0,this.isDestroyed=!1,this.blocks=[],this.numBlocks=10,this.images=["/image1.png","/image2.png","/image3.png"]}mount(){this.renderDOM(),this.initLenis(),this.initImageBlocks(),this.startLoop()}renderDOM(){const e=document.getElementById("two-d-root");e&&e.remove();const s=document.createElement("div");s.id="two-d-root",s.className="two-d-root",s.innerHTML=`
      <div class="nav">
        <h1>2D SCROLLER</h1>
